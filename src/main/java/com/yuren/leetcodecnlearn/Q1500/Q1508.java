...
public class Q1508 {
    ...
    private int getSum(int[] prefixSums, int[] prefixPrefixSums, int n, int k) {
    ...
    private int getKth(int[] prefixSums, int n, int k) {
    ...
    private int getCount(int[] prefixSums, int n, int x) {
        int count = 0;
        for (int i = 0, j = 1; i < n; i++) {
